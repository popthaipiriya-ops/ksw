        ...
        <div ref={scrollRef} className="hp-scroll-hide" style={{ display:'flex', gap:'16px', overflowX:'auto', scrollSnapType:'x mandatory', paddingBottom:'6px' }}>
          {cards.map((c, idx) => (
            <div key={idx} onClick={() => onCategoryChange(c.cat)}
              ...
              {/* พื้นหลังกล่องรูปไล่เฉดจากสีประจำหมวดหมู่แบบจางๆ ไปเป็นขาว — รูปจะได้กลืนไปกับสี
                  ของหมวดนั้นแทนที่จะเป็นกล่องเทาแบบเดียวกันทุกใบ ไม่มีเส้นขอบกั้นให้ดูแยกจากข้อความด้านล่าง */}
              <div style={{ height:'160px', background:`linear-gradient(180deg, ${c.accent}12 0%, #ffffff 100%)`, display:'flex', alignItems:'center', justifyContent:'center' }}>
