...
function hpImgNotify() {
  HP_IMG_SUBS.forEach(fn => {
    try {
      fn();
    } catch (e) {}
  });
...
function hpImgSetMap(map) {
  ...
  try {
    localStorage.setItem(HP_IMG_LS_KEY, JSON.stringify(HP_IMG_MAP));
  } catch (e) {}
  hpImgNotify();
}
...
try {
  HP_IMG_MAP = hpImgClean(JSON.parse(localStorage.getItem(HP_IMG_LS_KEY) || '{}'));
} catch (e) {}
...
function hpTxtNotify() {
  HP_TXT_SUBS.forEach(fn => {
    try {
      fn();
    } catch (e) {}
  });
...
function hpTxtSetMap(map) {
  ...
  try {
    localStorage.setItem(HP_TXT_LS_KEY, JSON.stringify(HP_TXT_MAP));
  } catch (e) {}
  hpTxtNotify();
}
try {
...
function HPProductDetailPage({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    style: {
      ...
      border: '1px solid #eef0f2',
      borderRadius: '999px',
      padding: brandTab && brandTab.logo ? '9px 22px' : '10px 22px'
    },
...
function HPBrandProductsPage({
  ...
  const searchResults = kw ? searchScope.filter(p => [p.code, p.name, p.brand, p.series, p.cat].some(v => String(v || '').toLowerCase().includes(kw))) : null;
  ...
  }, "\u0E2A\u0E34\u0E19\u0E04\u0E49\u0E32\u0E15\u0E32\u0E21\u0E41\u0E1A\u0E23\u0E19\u0E14\u0E4C"), !embedded && /*#__PURE__*/React.createElement("div", {
  ...
  }, searchResults.length, " \u0E23\u0E32\u0E22\u0E01\u0E32\u0E23"))), kw ? searchResults.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: '60px 20px',
      color: '#8fa39a',
  ...
  }, "\u0E44\u0E21\u0E48\u0E1E\u0E1A\u0E2A\u0E34\u0E19\u0E04\u0E49\u0E32\u0E17\u0E35\u0E48\u0E15\u0E23\u0E07\u0E01\u0E31\u0E1A \u201C", /*#__PURE__*/React.createElement("b", {
    style: {
      color: '#3a4a42'
    }
  ...
  }, "\u0E25\u0E49\u0E32\u0E07\u0E04\u0E33\u0E04\u0E49\u0E19"))) : /*#__PURE__*/React.createElement("div", {
  ...
  }, searchResults.map(card)) : visibleBrands.map((brandTab, bi) => {
...
function HPCatalogPage({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    loading: "lazy",
    decoding: "async",
    src: cfg[t.name] && cfg[t.name].img || t.product,
    style: {
      maxWidth: '80%',
      maxHeight: '80%',
      objectFit: 'contain'
...
function HPAdminLogin({
  ...
  }, "\u0E08\u0E31\u0E14\u0E01\u0E32\u0E23\u0E2A\u0E34\u0E19\u0E04\u0E49\u0E32 \u0E2D\u0E2D\u0E01\u0E43\u0E1A\u0E40\u0E2A\u0E19\u0E2D\u0E23\u0E32\u0E04\u0E32 \u0E41\u0E25\u0E30\u0E14\u0E39\u0E41\u0E25\u0E17\u0E35\u0E21\u0E07\u0E32\u0E19", /*#__PURE__*/React.createElement("br", null), "\u0E43\u0E19\u0E17\u0E35\u0E48\u0E40\u0E14\u0E35\u0E22\u0E27"))), /*#__PURE__*/React.createElement("form", {
    onSubmit: e => {
      e.preventDefault();
      submit();
    },
...
function HPAdminPage({
  ...
  useEffect(() => {
    hpApi('/auth/me').then(r => {
      ...
      setUser(u);
      setTab(hpCan(u, 'sales') ? 'dash' : 'products');
    }).catch(e => {
  ...
  if (!user) return /*#__PURE__*/React.createElement(HPAdminLogin, {
    onSuccess: s => {
      setUser(s);
      setTab(hpCan(s, 'sales') ? 'dash' : 'products');
    }
  });
  const logout = () => {
    hpApi('/auth/logout', {
  ...
  const tabs = [hpCan(user, 'sales') && ['dash', 'แดชบอร์ด'], hpCan(user, 'products') && ['products', 'จัดการสินค้า'], hpCan(user, 'sales') && ['sales', 'ระบบเซลล์'], hpCan(user, 'editProduct') && ['articles', 'บทความ'], hpCan(user, 'editProduct') && ['settings', 'ตั้งค่าเว็บไซต์'], hpCan(user, 'users') && ['users', 'จัดการผู้ใช้'], hpCan(user, 'users') && ['audit', 'ประวัติการใช้งาน'], hpCan(user, 'editProduct') && ['system', 'ระบบ']].filter(Boolean);
  return /*#__PURE__*/React.createElement("section", {
    style: {
      background: '#f6f6f6',
      minHeight: '80vh'
    ...
    me: user
  }), tab === 'dash' && hpCan(user, 'sales') && /*#__PURE__*/React.createElement(HPDashboard, {
    onGoTab: setTab
  }), tab === 'audit' && hpCan(user, 'users') && /*#__PURE__*/React.createElement(HPAuditLog, null), tab === 'system' && hpCan(user, 'editProduct') && /*#__PURE__*/React.createElement(HPSystemTools, null)));
}
...
function HPDashboard({
  ...
  useEffect(() => {
    hpApi('/dashboard').then(setD).catch(e => setErr('โหลดข้อมูลไม่สำเร็จ: ' + e.message));
  }, []);
  ...
  const tiles = [{
    l: 'ผู้เข้าชมวันนี้',
    v: (d.today.visits || 0).toLocaleString('th-TH'),
    s: `${d.days} วันล่าสุด ${(d.totals.visits || 0).toLocaleString('th-TH')}`
  }, {
    l: 'ลูกค้าทักวันนี้',
    v: (d.today.leads || 0).toLocaleString('th-TH'),
    s: `${d.days} วันล่าสุด ${(d.totals.leads || 0).toLocaleString('th-TH')}`
  }, {
    l: 'ใบเสนอราคาวันนี้',
    v: (d.today.quotes || 0).toLocaleString('th-TH'),
    s: `${d.days} วันล่าสุด ${(d.totals.quotes || 0).toLocaleString('th-TH')}`
  }, {
    l: 'ยอดเสนอราคาวันนี้',
    v: baht(d.today.sales),
    s: `${d.days} วันล่าสุด ${baht(d.totals.sales)}`
  }];
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, "\u0E1C\u0E39\u0E49\u0E40\u0E02\u0E49\u0E32\u0E0A\u0E21\u0E22\u0E49\u0E2D\u0E19\u0E2B\u0E25\u0E31\u0E07 ", d.days, " \u0E27\u0E31\u0E19"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '12px',
      color: '#9aa8a0',
      marginBottom: '16px'
    }
  }, "\u0E19\u0E31\u0E1A\u0E04\u0E23\u0E31\u0E49\u0E07\u0E40\u0E14\u0E35\u0E22\u0E27\u0E15\u0E48\u0E2D\u0E01\u0E32\u0E23\u0E40\u0E02\u0E49\u0E32\u0E0A\u0E21 \u0E44\u0E21\u0E48\u0E19\u0E31\u0E1A\u0E0B\u0E49\u0E33\u0E15\u0E2D\u0E19\u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19\u0E2B\u0E19\u0E49\u0E32"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'flex-end',
      gap: '6px',
  ...
  }, d.series.map((s, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    title: `${s.day} · ผู้เข้าชม ${s.visits} · ทัก ${s.leads} · ใบเสนอราคา ${s.quotes}`,
    style: {
      flex: 1,
      display: 'flex',
      flexDirection: 'column',
  ...
  }, s.visits || ''), /*#__PURE__*/React.createElement("div", {
    style: {
      width: '100%',
      height: Math.max(2, s.visits / max * 96) + 'px',
  ...
  }, s.day.slice(8)))))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: '1fr 1fr',
      gap: '16px'
  ...
  }, "\u0E2A\u0E34\u0E19\u0E04\u0E49\u0E32\u0E17\u0E35\u0E48\u0E25\u0E39\u0E01\u0E04\u0E49\u0E32\u0E16\u0E32\u0E21\u0E1A\u0E48\u0E2D\u0E22"), d.topProducts.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '13.5px',
      color: '#9aa8a0'
    }
  }, "\u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E21\u0E35\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25 \u2014 \u0E08\u0E30\u0E02\u0E36\u0E49\u0E19\u0E40\u0E21\u0E37\u0E48\u0E2D\u0E21\u0E35\u0E25\u0E39\u0E01\u0E04\u0E49\u0E32\u0E17\u0E31\u0E01\u0E40\u0E02\u0E49\u0E32\u0E21\u0E32\u0E16\u0E32\u0E21\u0E2A\u0E34\u0E19\u0E04\u0E49\u0E32") : d.topProducts.map((p, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      display: 'flex',
      gap: '10px',
  ...
  }, p.n, " \u0E04\u0E23\u0E31\u0E49\u0E07")))), /*#__PURE__*/React.createElement("div", {
    style: card
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '16px',
  ...
  }, "\u0E25\u0E39\u0E01\u0E04\u0E49\u0E32\u0E17\u0E35\u0E48\u0E17\u0E31\u0E01\u0E25\u0E48\u0E32\u0E2A\u0E38\u0E14"), d.recentLeads.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '13.5px',
      color: '#9aa8a0'
    }
  }, "\u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E21\u0E35\u0E25\u0E39\u0E01\u0E04\u0E49\u0E32\u0E17\u0E31\u0E01\u0E40\u0E02\u0E49\u0E32\u0E21\u0E32") : d.recentLeads.map((l, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      padding: '8px 0',
      borderBottom: '1px solid #f2f5f3'
  ...
  }, l.orderNo || '—'), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '12px',
      color: '#7d918a',
      overflow: 'hidden',
  ...
  }, l.product || 'ไม่ได้ระบุสินค้า', " \xB7 ", l.at ? new Date(l.at).toLocaleString('th-TH') : ''))))), /*#__PURE__*/React.createElement("div", {
    style: {
      ...card,
      marginTop: '16px'
    }
  ...
  }, "\u0E17\u0E32\u0E07\u0E25\u0E31\u0E14"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: '10px',
      flexWrap: 'wrap'
    }
  }, [['products', 'จัดการสินค้า'], ['sales', 'ออกใบเสนอราคา'], ['articles', 'เขียนบทความ'], ['settings', 'ตั้งค่าเว็บไซต์'], ['system', 'เครื่องมือระบบ']].map(([k, l]) => /*#__PURE__*/React.createElement("button", {
    key: k,
    onClick: () => onGoTab && onGoTab(k),
    style: {
      background: '#f2f7f5',
      color: '#0d6b5c',
  ...
  }, l)))), !d.members.available && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '12px',
      color: '#9aa8a0',
      marginTop: '14px',
  ...
  }, "\u0E2B\u0E21\u0E32\u0E22\u0E40\u0E2B\u0E15\u0E38: \u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E21\u0E35\u0E15\u0E31\u0E27\u0E40\u0E25\u0E02 \u201C\u0E2A\u0E21\u0E32\u0E0A\u0E34\u0E01\u0E43\u0E2B\u0E21\u0E48\u201D \u0E40\u0E1E\u0E23\u0E32\u0E30\u0E40\u0E27\u0E47\u0E1A\u0E19\u0E35\u0E49\u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E21\u0E35\u0E23\u0E30\u0E1A\u0E1A\u0E2A\u0E21\u0E32\u0E0A\u0E34\u0E01\u0E1D\u0E31\u0E48\u0E07\u0E40\u0E0B\u0E34\u0E23\u0E4C\u0E1F\u0E40\u0E27\u0E2D\u0E23\u0E4C (\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E2A\u0E21\u0E32\u0E0A\u0E34\u0E01\u0E40\u0E01\u0E47\u0E1A\u0E2D\u0E22\u0E39\u0E48\u0E43\u0E19\u0E40\u0E04\u0E23\u0E37\u0E48\u0E2D\u0E07\u0E25\u0E39\u0E01\u0E04\u0E49\u0E32\u0E40\u0E17\u0E48\u0E32\u0E19\u0E31\u0E49\u0E19 \u0E41\u0E25\u0E30\u0E22\u0E31\u0E07\u0E44\u0E21\u0E48\u0E44\u0E14\u0E49\u0E15\u0E31\u0E49\u0E07\u0E04\u0E48\u0E32 Google Sign-In)"));
}
...
function HPAuditLog() {
  ...
  const [q, setQ] = useState('');
  useEffect(() => {
    hpApi('/audit').then(setD).catch(e => setErr(e.message));
  }, []);
  const LABEL = {
    'login': 'เข้าสู่ระบบ',
    'login.failed': 'ล็อกอินไม่สำเร็จ',
    'user.create': 'เพิ่มผู้ใช้',
    'user.delete': 'ลบผู้ใช้',
    'user.setRole': 'เปลี่ยนบทบาท',
    'user.toggleActive': 'เปิด/ปิดบัญชี',
    'user.edit': 'แก้ข้อมูลผู้ใช้',
    'user.resetPassword': 'รีเซ็ตรหัสผ่าน',
    'products.save': 'บันทึกสินค้า',
    'image.upload': 'อัปโหลดรูป',
    'settings.save': 'บันทึกตั้งค่า',
    'quote.create': 'ออกใบเสนอราคา',
    'quote.delete': 'ลบใบเสนอราคา'
  };
  ...
  const rows = d.entries.filter(e => !q.trim() || (e.user + ' ' + e.name + ' ' + (LABEL[e.action] || e.action) + ' ' + e.detail).toLowerCase().includes(q.trim().toLowerCase()));
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#fff',
      borderRadius: '10px',
  ...
  }, "\u0E1B\u0E23\u0E30\u0E27\u0E31\u0E15\u0E34\u0E01\u0E32\u0E23\u0E43\u0E0A\u0E49\u0E07\u0E32\u0E19\u0E2B\u0E25\u0E31\u0E07\u0E1A\u0E49\u0E32\u0E19"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '13.5px',
      color: '#777',
      lineHeight: '1.8',
  ...
  }, "\u0E1A\u0E31\u0E19\u0E17\u0E36\u0E01\u0E40\u0E09\u0E1E\u0E32\u0E30\u0E01\u0E32\u0E23\u0E01\u0E23\u0E30\u0E17\u0E33\u0E17\u0E35\u0E48\u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19\u0E41\u0E1B\u0E25\u0E07\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25 \u0E41\u0E25\u0E30\u0E01\u0E32\u0E23\u0E25\u0E47\u0E2D\u0E01\u0E2D\u0E34\u0E19 (\u0E17\u0E31\u0E49\u0E07\u0E2A\u0E33\u0E40\u0E23\u0E47\u0E08\u0E41\u0E25\u0E30\u0E44\u0E21\u0E48\u0E2A\u0E33\u0E40\u0E23\u0E47\u0E08)", /*#__PURE__*/React.createElement("br", null), "\u0E44\u0E21\u0E48\u0E21\u0E35\u0E01\u0E32\u0E23\u0E40\u0E01\u0E47\u0E1A\u0E23\u0E2B\u0E31\u0E2A\u0E1C\u0E48\u0E32\u0E19\u0E2B\u0E23\u0E37\u0E2D\u0E04\u0E48\u0E32\u0E04\u0E35\u0E22\u0E4C\u0E25\u0E07\u0E43\u0E19\u0E1B\u0E23\u0E30\u0E27\u0E31\u0E15\u0E34 \xB7 \u0E40\u0E01\u0E47\u0E1A\u0E22\u0E49\u0E2D\u0E19\u0E2B\u0E25\u0E31\u0E07\u0E2A\u0E39\u0E07\u0E2A\u0E38\u0E14 1,000 \u0E23\u0E32\u0E22\u0E01\u0E32\u0E23"), /*#__PURE__*/React.createElement("input", {
    value: q,
    onChange: e => setQ(e.target.value),
    placeholder: "\u0E04\u0E49\u0E19\u0E2B\u0E32 \u0E40\u0E0A\u0E48\u0E19 \u0E0A\u0E37\u0E48\u0E2D\u0E1C\u0E39\u0E49\u0E43\u0E0A\u0E49 \u0E2B\u0E23\u0E37\u0E2D \u0E25\u0E1A\u0E1C\u0E39\u0E49\u0E43\u0E0A\u0E49",
    style: {
      width: '100%',
      maxWidth: '340px',
      padding: '9px 13px',
  ...
  }, "\u0E41\u0E2A\u0E14\u0E07 ", rows.length, " \u0E08\u0E32\u0E01 ", d.entries.length, " \u0E23\u0E32\u0E22\u0E01\u0E32\u0E23\u0E25\u0E48\u0E32\u0E2A\u0E38\u0E14 (\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14 ", d.total, ")")), /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#fff',
      borderRadius: '10px',
      border: '1px solid #eee',
  ...
  }, "\u0E44\u0E21\u0E48\u0E1E\u0E1A\u0E23\u0E32\u0E22\u0E01\u0E32\u0E23") : rows.map((e, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      display: 'flex',
      alignItems: 'center',
  ...
  }, LABEL[e.action] || e.action), /*#__PURE__*/React.createElement("span", {
    style: {
      flex: 1,
      minWidth: 0,
      fontSize: '13.5px',
  ...
  }, e.name, " (", e.user, ")"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '11.5px',
      color: '#9aa8a0',
      whiteSpace: 'nowrap',
...
function HPSiteSettings() {
  ...
  const uploadImage = async (name, file, inputEl) => {
    ...
    if (file.size > 12 * 1024 * 1024) {
      setErr('ไฟล์ใหญ่เกิน 12MB กรุณาย่อรูปก่อน');
      return;
    }
    setUploading(name);
    try {
  ...
  useEffect(() => {
    HP_IMG_SUBS.add(imgBump);
    HP_TXT_SUBS.add(imgBump);
    return () => {
      HP_IMG_SUBS.delete(imgBump);
      HP_TXT_SUBS.delete(imgBump);
    };
  }, []);
  ...
  const resetTexts = async () => {
    ...
    try {
      ...
      setErr('คืนข้อความเดิมไม่สำเร็จ: ' + e.message);
    }
    setImgBusy(false);
  };
  const resetImages = async () => {
    ...
    try {
      ...
      setErr('คืนรูปเดิมไม่สำเร็จ: ' + e.message);
    }
    setImgBusy(false);
  };
  ...
  return /*#__PURE__*/React.createElement("div", null, err && /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      label: "\u0E23\u0E39\u0E1B\u0E2B\u0E19\u0E49\u0E32\u0E41\u0E04\u0E15\u0E15\u0E32\u0E25\u0E47\u0E2D\u0E01",
      hint: "\u0E23\u0E2D\u0E07\u0E23\u0E31\u0E1A JPG / PNG / WEBP / GIF \u2014 \u0E23\u0E30\u0E1A\u0E1A\u0E22\u0E48\u0E2D\u0E23\u0E39\u0E1B\u0E43\u0E2B\u0E49\u0E2D\u0E31\u0E15\u0E42\u0E19\u0E21\u0E31\u0E15\u0E34 \u0E44\u0E21\u0E48\u0E15\u0E49\u0E2D\u0E07\u0E22\u0E48\u0E2D\u0E21\u0E32\u0E40\u0E2D\u0E07 \xB7 \u0E2D\u0E31\u0E1B\u0E41\u0E25\u0E49\u0E27\u0E01\u0E14 \u201C\u0E1A\u0E31\u0E19\u0E17\u0E36\u0E01\u0E01\u0E32\u0E23\u0E15\u0E31\u0E49\u0E07\u0E04\u0E48\u0E32\u201D \u0E14\u0E49\u0E32\u0E19\u0E25\u0E48\u0E32\u0E07\u0E14\u0E49\u0E27\u0E22"
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: '14px',
      ...
      style: {
        ...
        fontSize: '13.5px',
        fontWeight: '700',
        cursor: uploading === b.name ? 'default' : 'pointer',
        opacity: uploading === b.name ? 0.6 : 1
      }
    }, uploading === b.name ? 'กำลังอัปโหลด…' : 'เลือกรูปจากเครื่อง', /*#__PURE__*/React.createElement("input", {
      type: "file",
      accept: "image/*",
      disabled: uploading === b.name,
    ...
    }, "\u0E01\u0E25\u0E31\u0E1A\u0E44\u0E1B\u0E43\u0E0A\u0E49\u0E23\u0E39\u0E1B\u0E40\u0E14\u0E34\u0E21"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: '12px',
        color: r.img ? '#0d6b5c' : '#9aa8a0',
        marginTop: '8px'
      }
    }, r.img ? '● ใช้รูปที่อัปโหลดเองอยู่' : '○ ใช้รูปที่มากับเว็บ')))), /*#__PURE__*/React.createElement(Field, {
  ...
  }, "\u0E23\u0E39\u0E1B\u0E20\u0E32\u0E1E\u0E41\u0E25\u0E30\u0E02\u0E49\u0E2D\u0E04\u0E27\u0E32\u0E21\u0E17\u0E31\u0E49\u0E07\u0E40\u0E27\u0E47\u0E1A"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '13.5px',
      color: '#777',
      lineHeight: '1.8'
    }
  }, "\u0E41\u0E01\u0E49\u0E44\u0E14\u0E49\u0E08\u0E32\u0E01\u0E2B\u0E19\u0E49\u0E32\u0E40\u0E27\u0E47\u0E1A\u0E08\u0E23\u0E34\u0E07\u0E40\u0E25\u0E22 \u2014 \u0E01\u0E25\u0E31\u0E1A\u0E44\u0E1B\u0E2B\u0E19\u0E49\u0E32\u0E41\u0E23\u0E01 \u0E08\u0E30\u0E40\u0E2B\u0E47\u0E19\u0E1B\u0E38\u0E48\u0E21\u0E2A\u0E2D\u0E07\u0E1B\u0E38\u0E48\u0E21\u0E17\u0E35\u0E48\u0E21\u0E38\u0E21\u0E1A\u0E19\u0E0B\u0E49\u0E32\u0E22", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("b", {
    style: {
      color: '#f05a20'
    }
  }, "\u201C\u0E41\u0E01\u0E49\u0E23\u0E39\u0E1B\u0E20\u0E32\u0E1E\u201D"), " \u0E23\u0E39\u0E1B\u0E08\u0E30\u0E02\u0E36\u0E49\u0E19\u0E01\u0E23\u0E2D\u0E1A\u0E2A\u0E49\u0E21 \u0E01\u0E14\u0E43\u0E1A\u0E44\u0E2B\u0E19\u0E01\u0E47\u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19\u0E43\u0E1A\u0E19\u0E31\u0E49\u0E19 \xB7", /*#__PURE__*/React.createElement("b", {
    style: {
      color: '#1d4ed8'
    }
  }, " \u201C\u0E41\u0E01\u0E49\u0E02\u0E49\u0E2D\u0E04\u0E27\u0E32\u0E21\u201D"), " \u0E02\u0E49\u0E2D\u0E04\u0E27\u0E32\u0E21\u0E08\u0E30\u0E02\u0E36\u0E49\u0E19\u0E01\u0E23\u0E2D\u0E1A\u0E19\u0E49\u0E33\u0E40\u0E07\u0E34\u0E19 \u0E01\u0E14\u0E15\u0E23\u0E07\u0E44\u0E2B\u0E19\u0E01\u0E47\u0E41\u0E01\u0E49\u0E15\u0E23\u0E07\u0E19\u0E31\u0E49\u0E19"), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: '14px',
      display: 'flex',
      alignItems: 'center',
  ...
  }, "\u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19\u0E23\u0E39\u0E1B\u0E44\u0E1B\u0E41\u0E25\u0E49\u0E27 ", imgCount, " \u0E23\u0E39\u0E1B"), imgCount > 0 && /*#__PURE__*/React.createElement("button", {
    type: "button",
    disabled: imgBusy,
    onClick: resetImages,
    style: {
  ...
  }, imgBusy ? 'กำลังคืนค่า…' : 'คืนรูปเดิมทั้งหมด')), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: '10px',
      display: 'flex',
      alignItems: 'center',
  ...
  }, "\u0E41\u0E01\u0E49\u0E02\u0E49\u0E2D\u0E04\u0E27\u0E32\u0E21\u0E44\u0E1B\u0E41\u0E25\u0E49\u0E27 ", txtCount, " \u0E08\u0E38\u0E14"), txtCount > 0 && /*#__PURE__*/React.createElement("button", {
    type: "button",
    disabled: imgBusy,
    onClick: resetTexts,
    style: {
  ...
  }, imgBusy ? 'กำลังคืนค่า…' : 'คืนข้อความเดิมทั้งหมด'))), /*#__PURE__*/React.createElement("button", {
    onClick: save,
    disabled: saving,
    style: {
...
const HP_CHAT_STOPWORDS = new Set(['รุ่น', 'แบบ', 'ขนาด', 'ชนิด', 'สำหรับ', 'พร้อม', 'และ', 'ทาง', 'ตัว', 'ช่อง', 'สี', 'มี', 'ไม่', 'ที่', 'ของ', 'แบบมี', 'นิ้ว', 'วัตต์', 'series', 'type', 'no.', 'model']);
...
const hpChatPhrases = name => String(name || '').split(/[\s,·|/()]+/).filter(w => w.length >= 4 && !HP_CHAT_STOPWORDS.has(w.toLowerCase()));
...
const hpChatCodeTokens = q => (String(q || '').match(/[A-Za-z][A-Za-z0-9-]{3,}/g) || []).filter(t => /\d/.test(t));
...
function hpChatWindows(text, min = 4, max = 14) {
  ...
  const out = new Set();
  for (let len = min; len <= max; len++) for (let i = 0; i + len <= s.length; i++) out.add(s.slice(i, i + len));
  return out;
}
...
function hpChatFindProducts(query, current) {
  ...
  for (const c of hpChatAllCats(all)) {
    ...
    for (const w of win) if (cl.includes(w)) {
      catHit.add(c);
      break;
    }
  }
...
const hpBotSpecs = (p, max = 6) => (Array.isArray(p.specs) ? p.specs : []).filter(s => s && s.l && s.v && !HP_BOT_SPEC_HIDE.test(String(s.l))).slice(0, max);
...
function hpBotCleanItem(text) {
  ...
  for (let i = 0; i < 3; i++) {
    s = s.replace(/^(มี|ขาย|ขอ|หา|อยากได้|ต้องการ|สนใจ|ดู)\s*/, '').replace(/\s*(ไหม|มั้ย|บ้าง|หน่อย|อยู่|ครับ|ค่ะ|คะ)\s*\??$/, '').trim();
  }
...
function hpBotIsGreeting(text) {
  ...
  if (!s) return false;
  const rest = s.replace(/[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}\u{FE0F}]/gu, '') // อีโมจิ
  .replace(/สวัสดี(ตอน)?(เช้า|สาย|บ่าย|เย็น|ค่ำ)?|หวัดดี|ว่าดี/gi, '').replace(/ขอบคุณ(มาก)?|ขอบใจ|thank you|thanks|thank|thx/gi, '').replace(/hello|hallo|hi|hey|yo/gi, '').replace(/โอเค|okay|ok|ครับผม|ครับ|คับ|ค่ะ|คะ|ขอรับ|จ้า|จ้ะ|จ๊ะ|จ๋า|นะ|น้า|อ่อ|อ๋อ|อืม|เออ|ได้เลย|ได้/gi, '').replace(/[\s.,!?~ๆฯ]/g, '');
...
function hpBotAnswer(text, product) {
  ...
  if (hpBotHas(t, ['ติดต่อกลับ', 'ฝากทีมงาน', 'ฝากเบอร์', 'โทรกลับ', 'ให้ทีมงานติดต่อ'])) return {
    ask: true,
    reply: 'ได้เลยครับ ผมขอเก็บรายละเอียดสั้นๆ แล้วส่งให้ทีมงานติดต่อกลับนะครับ'
  };

  // ── 3) ข้อมูลร้าน — ข้อความตายตัว ตรงกับหน้าติดต่อเราเป๊ะ ──
  if (hpBotHas(t, ['ที่อยู่', 'แผนที่', 'ร้านอยู่', 'ไปยังไง', 'พิกัด', 'สาขา', 'ตั้งอยู่'])) return {
    ask: false,
    reply: 'ร้านอยู่ที่นี่ครับ\n' + HP_STORE_FACTS.address
  };
  if (hpBotHas(t, ['เวลาทำการ', 'เปิดกี่โมง', 'ปิดกี่โมง', 'เปิดวันไหน', 'วันหยุด', 'เปิดทำการ', 'เปิดกี่', 'กี่โมง'])) return {
    ask: false,
    reply: 'เวลาทำการของร้านครับ\n' + HP_STORE_FACTS.hours
  };
  if (hpBotHas(t, ['เบอร์', 'โทร', 'ติดต่อ', 'ไลน์', 'line', 'แอดไลน์'])) return {
    ask: false,
    reply: 'ติดต่อทีมงานได้ตามนี้ครับ\nโทร ' + HP_STORE_FACTS.phone + '\nLINE ' + HP_STORE_FACTS.lineId + '\nเวลาทำการ ' + HP_STORE_FACTS.hours
  };
  ...
  if (hpBotHas(t, ['บริการ', 'ติดตั้ง', 'ประกอบตู้', 'รับผลิต', 'งานโครงการ', 'รับทำ', 'mdb', '3 เฟส', 'สามเฟส'])) return {
    ask: true,
  ...
  return {
    ask: true,
    reply: 'ผมขอเก็บรายละเอียดความต้องการไว้ แล้วส่งให้ทีมงานดูแลต่อทางไลน์นะครับ'
  };
}
...
function HPChatWidget({
  ...
  const askAI = async (q, history) => {
    ...
    try {
      ...
      return {
        reply: d.reply,
        products: hits.slice(0, HP_BOT_CARD_MAX)
      };
    } catch (e) {
      return null;
    }
  ...
  const attachImage = async (file, inputEl) => {
    ...
    const warn = msg => setMsgs(m => [...m, {
      role: 'assistant',
      content: msg
    }]);
    if (!/^image\//.test(file.type)) {
      warn('ไฟล์นี้ไม่ใช่รูปภาพครับ รบกวนส่งเป็น JPG / PNG / WEBP นะครับ');
      return;
    }
    if (file.size > 12 * 1024 * 1024) {
      warn('ไฟล์ใหญ่เกินไปครับ รบกวนย่อรูปก่อนแล้วส่งใหม่นะครับ');
      return;
    }
    setAttaching(true);
    try {
  ...
  const send = async text => {
    ...
    setMsgs(m => [...m, {
      role: 'user',
      content: q,
      image: img ? img.preview : null
    }]);
    if (img) {
      setAttachedImage({
        url: img.url
      }); // ติดไปกับลิสต์ที่ส่งเข้าไลน์ ทีมงานจะได้เห็นรูป
      setPendingImage(null);
      ...
      if (!q) {
        setMsgs(m => [...m, {
          role: 'assistant',
          cats: true,
          content: 'รับรูปแล้วครับ 📷 เดี๋ยวผมแนบรูปนี้ส่งให้ทีมงานดูด้วย\n' + 'ผมดูจากรูปแล้วยืนยันรุ่นแทนทีมงานไม่ได้ครับ รบกวนช่วยบอกอีกนิดว่าเป็นอุปกรณ์ประเภทไหน ' + 'หรือถ้าบนตัวสินค้ามีรหัสรุ่น พิมพ์มาได้เลย เดี๋ยวผมค้นข้อมูลจริงในแคตตาล็อกให้ครับ'
        }]);
        return;
      }
      setMsgs(m => [...m, {
        role: 'assistant',
        content: 'รับรูปแล้วครับ 📷 เดี๋ยวผมแนบส่งให้ทีมงานดูด้วยนะครับ'
      }]);
    }
    ...
    if (form) {
      ...
      if (stepKey !== 'name' && hpBotIsGreeting(q)) {
        ...
        setMsgs(m => [...m, {
          role: 'assistant',
          content: (HP_BOT_GREET_THANKS.test(q) ? 'ยินดีครับ 🙏\n' : 'สวัสดีครับ 🙏\n') + back
        }]);
        return;
      }
    ...
    const history = [...msgs, {
      role: 'user',
      content: q
    }].filter(m => m.content && (m.role === 'user' || m.role === 'assistant')).map(m => ({
      role: m.role,
      content: m.content
    }));
    setThinking(true);
    ...
    if (a.ask && !collected) {
      const data = {};
      if (product) data.item = product.code + (product.name ? ' · ' + product.name : '');else {
  ...
  const sendCategory = cat => {
    ...
    if (a.ask && !collected) askStep({
      item: cat.label + ' (ลูกค้าส่งรูปมาให้ดู)'
    }, 0);
  };
  ...
  const productCard = (p, i) => {
    ...
    }, p.code), p.name && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: '11.5px',
        color: '#4a5a52',
        lineHeight: '1.45',
    ...
    }, [p.brand, p.cat, p.series].filter(Boolean).join(' · ')), specs.length > 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        flexWrap: 'wrap',
        gap: '4px',
    ...
    }, specs.map((s, k) => /*#__PURE__*/React.createElement("span", {
      key: k,
      style: {
        fontSize: '10px',
        color: '#0d6b5c',
  ...
  }, m.content), m.cats && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexWrap: 'wrap',
      gap: '6px',
  ...
  }, HP_CATEGORIES.map(c => /*#__PURE__*/React.createElement("button", {
    key: c.id,
    onClick: () => sendCategory(c),
    style: {
      background: '#fff',
      border: '1px solid #cfe3dc',
      color: '#0d6b5c',
  ...
  }, c.label))), m.products && m.products.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      width: '100%',
      marginTop: '7px'
    }
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, !open && /*#__PURE__*/React.createElement("div", {
  ...
  }, msgs.map(bubble), thinking && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'flex-start',
      marginBottom: '10px'
  ...
  }, "\u0E01\u0E33\u0E25\u0E31\u0E07\u0E1E\u0E34\u0E21\u0E1E\u0E4C\u2026")), msgs.length === 1 && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexWrap: 'wrap',
      gap: '7px',
  ...
  }, "\u2714 \u0E2A\u0E48\u0E07\u0E25\u0E34\u0E2A\u0E15\u0E4C\u0E40\u0E02\u0E49\u0E32\u0E44\u0E25\u0E19\u0E4C\u0E1A\u0E23\u0E34\u0E29\u0E31\u0E17\u0E41\u0E25\u0E49\u0E27 \u0E17\u0E35\u0E21\u0E07\u0E32\u0E19\u0E08\u0E30\u0E15\u0E34\u0E14\u0E15\u0E48\u0E2D\u0E01\u0E25\u0E31\u0E1A\u0E04\u0E23\u0E31\u0E1A", orderNo && /*#__PURE__*/React.createElement("div", {
    style: {
      fontWeight: '800',
      color: '#06352e',
      marginTop: '4px',
  ...
  }, "\u0E40\u0E25\u0E02\u0E17\u0E35\u0E48\u0E2D\u0E2D\u0E40\u0E14\u0E2D\u0E23\u0E4C ", orderNo)), /*#__PURE__*/React.createElement("a", {
    href: LINE,
    target: "_blank",
    rel: "noopener noreferrer",
    style: {
  ...
  }, "\u0E41\u0E19\u0E1A\u0E23\u0E39\u0E1B\u0E41\u0E25\u0E49\u0E27 \u2014 \u0E01\u0E14\u0E2A\u0E48\u0E07\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E43\u0E2B\u0E49\u0E17\u0E35\u0E21\u0E07\u0E32\u0E19\u0E14\u0E39\u0E23\u0E39\u0E1B\u0E19\u0E35\u0E49"), /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      ...
      border: '1px solid #dde7e2',
      background: '#fff',
      color: attaching ? '#c3d4cd' : '#0d6b5c',
      cursor: attaching ? 'default' : 'pointer',
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'center'
    }
  }, attaching ? /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '11px',
      fontWeight: '700'
    }
    ...
    maxLength: 1000,
    placeholder: pendingImage ? 'อยากถามอะไรเกี่ยวกับรูปนี้…' : 'พิมพ์คำถามที่นี่…',
    style: {
      flex: 1,
      minWidth: 0,
      padding: '10px 13px',
    ...
    style: {
      ...
      borderRadius: '50%',
      border: 'none',
      background: thinking || !input.trim() && !pendingImage ? '#c3d4cd' : '#0d6b5c',
      color: '#fff',
      cursor: thinking || !input.trim() && !pendingImage ? 'default' : 'pointer',
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'center'
    }
  ...
  }, "\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E2A\u0E34\u0E19\u0E04\u0E49\u0E32\u0E2D\u0E49\u0E32\u0E07\u0E2D\u0E34\u0E07\u0E08\u0E32\u0E01\u0E41\u0E04\u0E15\u0E15\u0E32\u0E25\u0E47\u0E2D\u0E01\u0E08\u0E23\u0E34\u0E07\u0E02\u0E2D\u0E07\u0E23\u0E49\u0E32\u0E19 \xB7 \u0E23\u0E32\u0E04\u0E32\u0E41\u0E25\u0E30\u0E02\u0E2D\u0E07\u0E1E\u0E23\u0E49\u0E2D\u0E21\u0E2A\u0E48\u0E07 \u0E17\u0E35\u0E21\u0E07\u0E32\u0E19\u0E40\u0E1B\u0E47\u0E19\u0E1C\u0E39\u0E49\u0E41\u0E08\u0E49\u0E07\u0E17\u0E32\u0E07\u0E44\u0E25\u0E19\u0E4C")));
}
...
function HPImageEditor() {
  ...
  useEffect(() => {
    hpApi('/auth/me').then(r => setCanEdit(!!(r.can && r.can.editProduct))).catch(() => {});
  }, []);
  ...
  useEffect(() => {
    ...
    const onClick = e => {
      ...
      setTarget(on === 'img' ? {
        kind: 'img',
        path: hit.getAttribute('data-hpimg')
      } : {
        kind: 'txt',
        path: hit.getAttribute('data-hptxt')
      });
    };
    document.addEventListener('click', onClick, true);
    // นับของที่แก้ได้ในหน้านี้ ให้แอดมินรู้ว่าโหมดทำงานอยู่จริง
    const tick = () => setCount(document.querySelectorAll(on === 'img' ? 'img[data-hpimg]' : '[data-hptxt]').length);
    tick();
  ...
  useEffect(() => {
    HP_IMG_SUBS.add(bump);
    HP_TXT_SUBS.add(bump);
    return () => {
      HP_IMG_SUBS.delete(bump);
      HP_TXT_SUBS.delete(bump);
    };
  }, []);
  ...
  useEffect(() => {
    if (target && target.kind === 'txt') setDraft(HP_TXT_MAP[target.path] || target.path);
  }, [target]);
  const saveText = async value => {
    ...
    try {
      ...
      if (!value.trim() || value.trim() === target.path) delete next[target.path];else next[target.path] = value.trim();
      const r = await hpApi('/settings', {
        method: 'POST',
        body: {
          settings: {
  ...
  const pickFile = async (file, inputEl) => {
    ...
    setNote('');
    if (!/^image\//.test(file.type)) {
      setErr('ต้องเป็นไฟล์รูปเท่านั้น (JPG / PNG / WEBP / GIF)');
      return;
    }
    if (file.size > 12 * 1024 * 1024) {
      setErr('ไฟล์ใหญ่เกิน 12MB กรุณาย่อรูปก่อน');
    ...
    try {
      const dataUrl = await hpShrinkImageFile(file, 1600);
      const up = await hpApi('/catalog-image', {
        method: 'POST',
        body: {
          key: hpImgSlotKey(target.path),
          dataUrl
        }
      });
      await saveMap({
      ...
      setErr('เปลี่ยนรูปไม่สำเร็จ: ' + (e.message || e));
    }
    setBusy(false);
  };
  const revert = async () => {
    ...
    try {
      ...
      setErr('คืนรูปเดิมไม่สำเร็จ: ' + (e.message || e));
    }
    setBusy(false);
  };
  ...
  const tabCss = (active, color) => ({
    ...
    padding: '10px 16px',
    fontSize: '13.5px',
    background: active ? color : '#0d6b5c',
    color: '#fff',
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    onClick: () => setOn(v => v === 'img' ? false : 'img'),
    style: tabCss(on === 'img', '#f05a20')
  }, /*#__PURE__*/React.createElement("svg", {
    width: "16",
    height: "16",
    viewBox: "0 0 24 24",
    ...
    d: "M21 15l-5-5L5 21"
  })), on === 'img' ? 'ปิดโหมดแก้รูป' : 'แก้รูปภาพ'), /*#__PURE__*/React.createElement("button", {
    onClick: () => setOn(v => v === 'txt' ? false : 'txt'),
    style: tabCss(on === 'txt', '#1d4ed8')
  }, /*#__PURE__*/React.createElement("svg", {
    width: "16",
    height: "16",
    viewBox: "0 0 24 24",
    ...
    d: "M9 19h6"
  })), on === 'txt' ? 'ปิดโหมดแก้ข้อความ' : 'แก้ข้อความ')), on && /*#__PURE__*/React.createElement("div", {
    style: {
      pointerEvents: 'auto',
  ...
  }, on === 'img' ? 'กดที่รูปใบไหนก็ได้เพื่อเปลี่ยนรูปนั้น' : 'กดที่ข้อความไหนก็ได้เพื่อแก้ข้อความนั้น', /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#9fe6d4'
    }
  }, on === 'img' ? `หน้านี้เปลี่ยนได้ ${count} รูป · แก้ไปแล้วทั้งเว็บ ${changed} รูป` : `หน้านี้แก้ได้ ${count} จุด · แก้ไปแล้วทั้งเว็บ ${txtChanged} ข้อความ`))), target && target.kind === 'txt' && /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u0E41\u0E01\u0E49\u0E02\u0E49\u0E2D\u0E04\u0E27\u0E32\u0E21\u0E19\u0E35\u0E49"), err && /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#fdecea',
      border: '1px solid #f5c6cb',
      color: '#b3261e',
  ...
  }, err), note && /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#e8f7ee',
      border: '1px solid #b7e4c7',
      color: '#0d6b3f',
  ...
  }, "\u0E02\u0E49\u0E2D\u0E04\u0E27\u0E32\u0E21\u0E40\u0E14\u0E34\u0E21"), /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#f4f7f5',
      border: '1px solid #e2e6e3',
      borderRadius: '8px',
  ...
  }, target.path), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '11.5px',
      fontWeight: '700',
      color: '#667',
  ...
  }, "\u0E02\u0E49\u0E2D\u0E04\u0E27\u0E32\u0E21\u0E43\u0E2B\u0E21\u0E48"), /*#__PURE__*/React.createElement("textarea", {
    value: draft,
  ...
  }, draft.length, " / 400 \u0E15\u0E31\u0E27\u0E2D\u0E31\u0E01\u0E29\u0E23"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: '10px',
      flexWrap: 'wrap'
    ...
    disabled: busy,
    onClick: () => saveText(draft),
    style: {
      ...btnCss,
      background: '#1d4ed8',
      color: '#fff'
    }
  }, busy ? 'กำลังบันทึก…' : 'บันทึกข้อความ'), HP_TXT_MAP[target.path] !== undefined && /*#__PURE__*/React.createElement("button", {
    disabled: busy,
    onClick: () => saveText(''),
    style: {
      ...btnCss,
  ...
  }, "\u0E04\u0E37\u0E19\u0E02\u0E49\u0E2D\u0E04\u0E27\u0E32\u0E21\u0E40\u0E14\u0E34\u0E21"), /*#__PURE__*/React.createElement("button", {
    disabled: busy,
  ...
  }, "\u0E02\u0E49\u0E2D\u0E04\u0E27\u0E32\u0E21\u0E40\u0E14\u0E34\u0E21\u0E19\u0E35\u0E49\u0E16\u0E39\u0E01\u0E43\u0E0A\u0E49\u0E15\u0E23\u0E07\u0E44\u0E2B\u0E19\u0E02\u0E2D\u0E07\u0E40\u0E27\u0E47\u0E1A\u0E1A\u0E49\u0E32\u0E07 \u0E08\u0E30\u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19\u0E15\u0E32\u0E21\u0E01\u0E31\u0E19\u0E17\u0E38\u0E01\u0E08\u0E38\u0E14"))), target && target.kind === 'img' && /*#__PURE__*/React.createElement("div", {
    onClick: () => !busy && setTarget(null),
    style: {
      position: 'fixed',
      inset: 0,
  ...
  }, "\u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19\u0E23\u0E39\u0E1B\u0E19\u0E35\u0E49"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '11.5px',
      color: '#9aa8a0',
      marginBottom: '16px',
  ...
  }, target.path), err && /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#fdecea',
      border: '1px solid #f5c6cb',
      color: '#b3261e',
  ...
  }, [['รูปเดิมที่มากับเว็บ', target.path], ['รูปที่ใช้อยู่ตอนนี้', override || target.path]].map(([lbl, src], i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      flex: 1,
      minWidth: 0
  ...
  }, busy ? 'กำลังอัปโหลด…' : 'เลือกรูปใหม่จากเครื่อง'), override && /*#__PURE__*/React.createElement("button", {
    disabled: busy,
    onClick: revert,
    style: {
      ...btnCss,
  ...
  }, "\u0E04\u0E37\u0E19\u0E23\u0E39\u0E1B\u0E40\u0E14\u0E34\u0E21"), /*#__PURE__*/React.createElement("button", {
    disabled: busy,
    onClick: () => setTarget(null),
    style: {
      ...btnCss,
  ...
  }, "\u0E1B\u0E34\u0E14")), /*#__PURE__*/React.createElement("input", {
    ref: fileRef,
    type: "file",
    accept: "image/*",
    style: {
  ...
  }, "\u0E23\u0E30\u0E1A\u0E1A\u0E22\u0E48\u0E2D\u0E23\u0E39\u0E1B\u0E43\u0E2B\u0E49\u0E2D\u0E31\u0E15\u0E42\u0E19\u0E21\u0E31\u0E15\u0E34 \u0E44\u0E21\u0E48\u0E15\u0E49\u0E2D\u0E07\u0E22\u0E48\u0E2D\u0E21\u0E32\u0E40\u0E2D\u0E07 \xB7 \u0E23\u0E2D\u0E07\u0E23\u0E31\u0E1A JPG / PNG / WEBP / GIF", /*#__PURE__*/React.createElement("br", null), "\u0E23\u0E39\u0E1B\u0E40\u0E14\u0E34\u0E21\u0E44\u0E1F\u0E25\u0E4C\u0E19\u0E35\u0E49\u0E16\u0E39\u0E01\u0E43\u0E0A\u0E49\u0E15\u0E23\u0E07\u0E44\u0E2B\u0E19\u0E02\u0E2D\u0E07\u0E40\u0E27\u0E47\u0E1A\u0E1A\u0E49\u0E32\u0E07 \u0E08\u0E30\u0E40\u0E1B\u0E25\u0E35\u0E48\u0E22\u0E19\u0E15\u0E32\u0E21\u0E01\u0E31\u0E19\u0E17\u0E38\u0E01\u0E08\u0E38\u0E14"))));
}
function HPApp() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onCategoryChange: onCategoryChange,
    onNavigate: onNavigate
  }), /*#__PURE__*/React.createElement(HPChatWidget, {
    onSelectProduct: onSelectProduct
  }), /*#__PURE__*/React.createElement(HPImageEditor, null), /*#__PURE__*/React.createElement("div", {
